...
?>
<!-- HTML del sidebar para administrador -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="sidebar hidden peer-checked:flex md:flex flex-col">
        ...
        <div class="flex flex-col flex-1 overflow-y-auto">
            <nav class="flex-1 px-2 py-4 bg-[var(--verde)]">
                <!-- Inicio -->
                <a href="index.php" class="flex items-center px-6 py-4 text-gray-100 hover:bg-[var(--verdes)] group">
                ...
                <a href="herramientas.php" class="flex items-center px-6 py-4 text-gray-100 hover:bg-[var(--verdes)] group">
					...
					<!-- Utilidad -->
                    <a href="utilidad.php" class="flex items-center px-6 py-4 text-gray-100 hover:bg-[var(--verdes)] group">
						<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="group-hover:hidden h-6 w-6 mr-2">
					...
					<!-- Usuarios -->
                    <a href="users.php" class="flex items-center px-6 py-4 text-gray-100 hover:bg-[var(--verdes)] group">
						<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="group-hover:hidden h-6 w-6 mr-2">
					...
					<!-- Empresa -->
                    <a href="empresa.php" class="flex items-center px-6 py-4 text-gray-100 hover:bg-[var(--verdes)] group">
						<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="group-hover:hidden h-6 w-6 mr-2">
					...
					<!-- Estados -->
                    <a href="estados.php" class="flex items-center px-6 py-4 text-gray-100 hover:bg-[var(--verdes)] group">
						<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="group-hover:hidden h-6 w-6 mr-2">
					...
					<!-- Técnico -->
					<a href="tecnico.php" class="flex items-center px-6 py-4 text-gray-100 hover:bg-[var(--verdes)] group">
						<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="group-hover:hidden h-6 w-6 mr-2">
