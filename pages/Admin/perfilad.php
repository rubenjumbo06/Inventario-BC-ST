        ...
        <div class="flex flex-col md:flex-row">
            ...
            <div class="md:w-2/3 md:pl-8">
                ...
                <div class="flex flex-wrap gap-2 mb-6">
                    ...
                    <span class="bg-green-100 text-[#22694c] px-3 py-1 rounded-full text-sm cursor-pointer">Empresa</span>
                    <span class="bg-green-100 text-[#22694c] px-3 py-1 rounded-full text-sm cursor-pointer">Estados</span>
