...
try {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // Validar el username (letras, números, sin espacios ni caracteres especiales)
        if (!preg_match('/^[A-Za-z0-9]+$/', $username)) {
            throw new Exception("El username solo puede contener letras y números, sin espacios ni caracteres especiales.");
        }
