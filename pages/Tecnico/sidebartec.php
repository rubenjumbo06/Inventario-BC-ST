    ...
    <div class="sidebar hidden peer-checked:flex md:flex flex-col">
        ...
        <div class="flex flex-col flex-1 overflow-y-auto">
            <nav class="flex-1 px-2 py-4 bg-[var(--verde)]">
                    <!-- Inicio -->
                    <a href="indextec.php" class="flex items-center px-6 py-4 text-gray-100 hover:bg-[var(--verdes)] group">
                    ...
                    <!-- Registrar Entrada -->
                    <a href="reg_entradas.php" class="flex items-center px-6 py-4 text-gray-100 hover:bg-[var(--verdes)] group">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="group-hover:hidden h-6 w-6 mr-2">
                    ...
                    <!-- Registrar Salida -->
                    <a href="reg_salidas.php" class="flex items-center px-6 py-4 text-gray-100 hover:bg-[var(--verdes)] group">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="group-hover:hidden h-6 w-6 mr-2">
                    ...
                    <!-- Tabla Entradas -->
                    <a href="entradas.php" class="flex items-center px-6 py-4 text-gray-100 hover:bg-[var(--verdes)] group">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="group-hover:hidden h-6 w-6 mr-2">
                    ...
                    <!-- Tabla Salidas -->
                    <a href="salidas.php" class="flex items-center px-6 py-4 text-gray-100 hover:bg-[var(--verdes)] group">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="group-hover:hidden h-6 w-6 mr-2">
